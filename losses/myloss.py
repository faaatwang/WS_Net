...
from losses.networks import Discriminator
from losses.image_gradient_loss import ImageGradientLoss
...
class EdgeConnectLoss(nn.Module):
    def __init__(self,
                 ...
                 g_rec_loss_weight=1,
                 g_gradient_loss_weight=0.1,
                 g_content_loss_weight=0.01,
                 g_style_loss_weight=5.0,
                 norm_to_0_1=True,
                 ):
        super().__init__()
    ...
    def forward(self,
        ...
        if name == 'generator':
            ...
            if self.g_rec_loss_weight > 0:
                ...
                gen_rec_loss = self.l1_loss(reconstruction, image) * self.g_rec_loss_weight
